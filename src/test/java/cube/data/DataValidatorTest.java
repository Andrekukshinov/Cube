...
public class DataValidatorTest {
    ...
    public void testValidateStringShouldValidateStringAndReturnFalse() {
        DataValidator validator = new DataValidator();
        //when
        boolean result = validator.validateString(STRING_COORDINATES_INVALID_MIDDLE);
        //then
    ...
    public void testValidateStringShouldParseString2Instead3AndReturnFalse() {
        DataValidator validator = new DataValidator();
        //when
        boolean result = validator.validateString(STRING_COORDINATES_INVALID_2_INSTEAD_3);
        //then
        Assert.assertFalse(result);
    }
    @Test
    public void testValidateStringShouldParseString7Instead8AndReturnFalse() {
        DataValidator validator = new DataValidator();
        //when
        boolean result = validator.validateString(STRING_COORDINATES_INVALID_7_INSTEAD_8);
        //then
        Assert.assertFalse(result);
    }
    @Test
    public void testValidateStringShouldParseString9Instead8AndReturnFalse() {
        DataValidator validator = new DataValidator();
        //when
        boolean result = validator.validateString(STRING_COORDINATES_INVALID_9_INSTEAD_8);
        //then
        Assert.assertFalse(result);
    }
    @Test
    public void testValidateStringShouldParseStringWithCharInDoubleAndReturnFalse() {
        DataValidator validator = new DataValidator();
        //when
        boolean result = validator.validateString(STRING_COORDINATES_INVALID_DOUBLE);
        //then
        Assert.assertFalse(result);
    }
}
